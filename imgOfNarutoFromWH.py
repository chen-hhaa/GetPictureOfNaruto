...
def downloadImg(driver):
    ...
    size_bt = driver.find_element_by_xpath('//*[@id="respicker-form"]/div/table/tbody/tr[3]/td[2]/label')#选择尺寸
    size_bt.click()
...
if __name__=='__main__':
    ...
    driver = webdriver.Chrome('C:/Users/陈海辉/AppData/Local/Programs/Python/Python38/Lib/chromedriver.exe')#chromedriver的存放目录
